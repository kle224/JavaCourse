...
//		// - fill the array with ascending numbers and print it
//		// - iterating through the array and sums up each value which is placed on the primary or
//		//  secondary diagonal. E.g. for this: (x = element placed, o = not placed) (3x3-array)
//		// xox		1st row
//		// oxo		2nd row
//		// xox		3rd row
